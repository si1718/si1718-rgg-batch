...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="batch" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" data.streaming.test.Batch %CMD_LINE_ARGS%
